...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="admin_pedidos.php" class="active">Pedidos</a>
    ...
    <div class="content">
        ...
        <div class="main-content">
            ...
            <p>Esta sección permite gestionar los pedidos realizados por los clientes.</p>
            <main class="container mt-4">
                <div class="d-flex justify-content-between">
                    <h2>Lista de Pedidos</h2>
                    <a href="fpdf/reportePedidos.php" target="_blank" class="btn btn-primary btn-lg mt-3">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered" id="tablaPedidos">
                        ...
                        <tbody>
                            <!-- Aquí se llenarán los pedidos con AJAX -->
                        </tbody>
                    </table>
                </div>
            </main>
    ...
    <script script src="js/admin_pedidos.js"></script>
</body>
