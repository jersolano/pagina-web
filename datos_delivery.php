...
<head>
    ...
    <title>Datos para Delivery - Pollería El Deleite</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="text-center py-3 shadow">
        <h1 class="fw-bold">Datos para Delivery</h1>
        ...
        <div class="card p-4 w-100 bg-transparent" style="max-width: 400px;">
            <form id="formRecoger">
                ...
                <div class="mb-3">
                    ...
                    <p>⚠️ Se cobrará un adicional de <strong>S/ 3.00</strong> por delivery.</p>
                </div>
    ...
    <script src="js/datos_delivery.js"></script>
